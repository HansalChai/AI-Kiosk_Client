// src/app/(after ai cam)/complex/menu/bread/page.tsx
"use client";
import Image from "next/image";
import styles from "./page.module.css";
import Link from "next/link";
import { dummyComplexBread } from "@/data/complex/dummyComplexBread"; // 더미 데이터 가져오기

export default function Complex() {
  return (
    <div className={styles.grid}>
      {dummyComplexBread.map((item, index) => (
